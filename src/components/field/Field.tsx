  ...
  return (
    <Switch fallback={<ErrorNotification error={`unexpected field type ${type()}`} />}>
      ...
      <Match when={type() === "info"}>
        <FieldInfo config={props.config as ConfigCellInfo} value={props.value as CellValueInfo} />
      </Match>
      <Match when={type() === "format"}>
        <FieldFormat value={props.value as CellValueFormat} />
      </Match>
      <Match when={type() === "genotype"}>
        <FieldGenotype config={props.config as ConfigCellGenotype} value={props.value as CellValueGenotype} />
        <></>
      </Match>
