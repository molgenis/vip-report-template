...
// import { SearchBox, SearchChangeEvent } from "../components/SearchBox";
// import { InfoFilters } from "../components/filter_old/InfoFilters";
// import { Sort, SortChangeEvent } from "../components/Sort";
...
// import { RecordsPerPage, RecordsPerPageChangeEvent } from "../components/RecordsPerPage";
// import { FilterChangeEvent, FilterClearEvent } from "../components/filter_old/Filter";
//
// export const VariantsView: Component = () => {
...
//
//   const onPageChange = (event: PageChangeEvent) => actions.setVariantsPage(event.page);
//   const onSearchChange = (event: SearchChangeEvent) => actions.setVariantsSearchQuery(event.value);
...
//   const onSortChange = (event: SortChangeEvent) => actions.setVariantsSort(event.order);
//   const onSortClear = () => actions.setVariantsSort(null);
//   const onRecordsPerPageChange = (event: RecordsPerPageChangeEvent) => actions.setVariantsPageSize(event.number);
//   const params = (): Params => {
//     return {
